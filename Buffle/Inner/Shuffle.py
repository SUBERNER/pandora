...
def normal(files: str | list[str], contains: str | list[str]):
    ...
    Buffle.display_file_results.set_length(max(files, key=len))
    ...
    for index, entry in enumerate(files):
        ...
        while text.count(placeholder) > 0:
            ...
            Buffle.display_text_results.result(files[index], "\033[36mNormal Text Shuffle\033[0m", random_matches.pop(0), original_matches.pop(0))
        ...
        with open(entry, 'r') as file:  # opens file
            ...
            while placeholder in text:
                for index in range(len(contains)):
                    ...
                    Buffle.display_text_results.result(source, "\033[34mGroup Text Shuffle\033[0m", random_matches[0][0][index],original_matches[0][0][index])
