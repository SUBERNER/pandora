...
def normal_output(files: str | list[str], contains: str | list[str], *, ignores: Ignore | list[Ignore] | None = None, excludes: Exclude | list[Exclude] | None = None, flags: list[re.RegexFlag] = None):
    pass

def group_output(files: str | list[str], contains: str | list[str], *, ignores: Ignore | list[Ignore] | None = None, excludes: Exclude | list[Exclude] | None = None, flags: list[re.RegexFlag] = None):
    pass